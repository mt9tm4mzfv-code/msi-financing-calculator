...
(function(){
  ...
  // Clipboard ownership is centralized in ui-result-enhancements.js.
  // No document-level COPY RESULT interception here.
  ...
  function init(){installStyle();rates();renderBanner();syncRates();setTimeout(()=>{installStyle();renderBanner();syncRates();},100);setTimeout(()=>{renderBanner();syncRates();},500);setTimeout(()=>{},1500)}
